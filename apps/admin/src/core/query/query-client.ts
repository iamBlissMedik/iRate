...
export const queryKeys = {
  ...
  admin: {
    ...
    dashboard: {
      ...
      overview: () => [...queryKeys.admin.dashboard.all(), "overview"] as const,
    },
    ...
    // KYC management
    kyc: {
      all: () => [...queryKeys.admin.all(), "kyc"] as const,
      lists: () => [...queryKeys.admin.kyc.all(), "list"] as const,
      list: (filters?: Record<string, unknown>) =>
        [...queryKeys.admin.kyc.lists(), filters] as const,
      detail: (id: string) => [...queryKeys.admin.kyc.all(), id] as const,
    },

    // Wallets management
    wallets: {
      all: () => [...queryKeys.admin.all(), "wallets"] as const,
      balance: () => [...queryKeys.admin.wallets.all(), "balance"] as const,
      lists: () => [...queryKeys.admin.wallets.all(), "list"] as const,
      list: (filters?: Record<string, unknown>) =>
        [...queryKeys.admin.wallets.lists(), filters] as const,
    },
  },
} as const;
